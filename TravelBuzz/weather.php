...
<section class="header">
   ...
   <nav class="navbar">
      ...
      <a href="funt.html">News</a>
      <a href="funt.html">Weather</a>
...
<section class="news-con">
    <div class="content">
      <h3>Get Real Time Weather update<h3>
    </div>
  </section>
...
<div class="card-w">
    <div class="search">
      ...
      <button onclick="check()"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="weather loading">
      <h2 class="city">Weather in Vellore</h2>
